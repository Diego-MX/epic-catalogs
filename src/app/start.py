...
@app.post('/zipcode-neighborhoods', 
    response_model=models.NeighborhoodsResponse, tags=['Legacy'])
...
@app.get('/national-banks/parse-clabe/{clabe_key}', 
    response_model=models.Bank, tags=['Banks'])
...
@app.get('/national-banks/card-number/{card_number}', 
    response_model=models.CardsBin, tags=['Banks'])
